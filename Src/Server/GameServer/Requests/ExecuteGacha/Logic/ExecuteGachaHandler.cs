...
namespace Puniemu.Src.Server.GameServer.Requests.ExecuteGacha.Logic
{
    public class ExecuteGachaHandler
    {
        ...
        public static async Task HandleAsync(HttpContext ctx)
        {
            ...
            var userData = (await DBService.Logic.DBService.GetYwpUserAsync<GameServer.DataClasses.YwpUserData>(deserialized!.Level5UserId!, "ywp_user_data"))!;
            //gacha info
            ...
            var itmesListTable = new TableParser.Logic.TableParser(await DBService.Logic.DBService.GetYwpUserAsync<string>(deserialized!.Level5UserId!, "ywp_user_item")!);

            var DictionaryListTable = new TableParser.Logic.TableParser(await DBService.Logic.DBService.GetYwpUserAsync<string>(deserialized!.Level5UserId!, "ywp_user_dictionary")!);
            var UserYoukaiTable = new TableParser<YwpUserYoukai>(await DBService.Logic.DBService.GetYwpUserAsync<string>(deserialized!.Level5UserId!, "ywp_user_youkai")!);

            var UserYoukaiSkillTable = new TableParser<YwpUserYoukaiSkill>(await DBService.Logic.DBService.GetYwpUserAsync<string>(deserialized!.Level5UserId!, "ywp_user_youkai_skill")!);
            ...
            var TutorialListTable = new TableParser<YwpUserTutorialList>(await DBService.Logic.DBService.GetYwpUserAsync<string>(deserialized!.Level5UserId!, "ywp_user_tutorial_list")!);
            ...
            await DBService.Logic.DBService.SetYwpUserAsync(deserialized!.Level5UserId!, "ywp_user_dictionary", DictionaryListTable.ToString());
            await DBService.Logic.DBService.SetYwpUserAsync(deserialized!.Level5UserId!, "ywp_user_youkai_skill", UserYoukaiSkillTable.ToString());
            ...
            await DBService.Logic.DBService.SetYwpUserAsync(deserialized!.Level5UserId!, "ywp_user_item", itmesListTable.ToString());
            await DBService.Logic.DBService.SetYwpUserAsync(deserialized!.Level5UserId!, "ywp_user_tutorial_list", TutorialListTable.ToString());
