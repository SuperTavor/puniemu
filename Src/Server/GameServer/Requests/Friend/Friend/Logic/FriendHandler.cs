...
namespace Puniemu.Src.Server.GameServer.Requests.Friend.Logic
{
    public class FriendsHandler
    {
        public static async Task HandleAsync(HttpContext ctx)
        {
            ...
            instance.YwpUserFriendRequestRecv = await DBService.Logic.DBService.GetYwpUserAsync<List<FriendRequestEntry>>(deserialized.Level5UserID!, "ywp_user_friend_request_recv");
            ...
            instance.YwpUserFriend = await DBService.Logic.DBService.GetYwpUserAsync<List<FriendEntry>>(deserialized.Level5UserID!, "ywp_user_friend");
            ...
            instance.YwpUserFriendStarRank = await DBService.Logic.DBService.GetYwpUserAsync<List<FriendRankEntry>>(deserialized.Level5UserID!, "ywp_user_friend_star_rank");
            instance.YwpUserFriendRank = await DBService.Logic.DBService.GetYwpUserAsync<List<FriendRankEntry>>(deserialized.Level5UserID!, "ywp_user_friend_rank");
