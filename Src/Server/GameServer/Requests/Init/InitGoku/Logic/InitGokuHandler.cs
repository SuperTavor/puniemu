...
namespace Puniemu.Src.Server.GameServer.Requests.InitGoku.Logic
{
    public class InitGokuHandler
    {
        public static async Task HandleAsync(HttpContext ctx)
        {
            ...
            res.YwpUserGokuStory = await DBService.Logic.DBService.GetYwpUserAsync<List<Dictionary<string, object>>>(deserialized!.Level5UserId!, "ywp_user_goku_story");
            res.YwpUserData = await DBService.Logic.DBService.GetYwpUserAsync<YwpUserData>(deserialized!.Level5UserId!, "ywp_user_data");
            res.YwpUserGokuYoukaiIntroRelease = await DBService.Logic.DBService.GetYwpUserAsync<List<YwpUserGokuYoukaiIntroReleaseEntry>>(deserialized!.Level5UserId!, "ywp_user_goku_youkai_intro_release")!;
            ...
            await DBService.Logic.DBService.SetYwpUserAsync(deserialized!.Level5UserId!, "ywp_user_goku_youkai_intro_release", res.YwpUserGokuYoukaiIntroRelease!);
