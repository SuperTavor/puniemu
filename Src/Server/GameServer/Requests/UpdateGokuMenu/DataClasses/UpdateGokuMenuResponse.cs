            ...
            try
            {
                if (!string.IsNullOrEmpty(request?.DeviceId))
                {
                    ...
                    if (gdkeys != null && gdkeys.Count > 0)
                    {
                        ...
                        await Puniemu.Src.DBService.Logic.DBService.SetYwpUserAsync(gdkeys[0], "ywp_user_goku_menu",
                ...
                if (!string.IsNullOrEmpty(request?.DeviceId))
                {
                    ...
                    if (gdkeys != null && gdkeys.Count > 0)
                    {
                        ...
                        if (request?.GokuMenuId > 0)
                        {
                            ...
                            await Puniemu.Src.DBService.Logic.DBService.SetYwpUserAsync(gdkeys[0],
