...
namespace Puniemu.Src.Server.GameServer.Logic
{
    public class MoneyExpManager
    {
        ...
        */
        ...
        public static async Task GiveYoukaiExp(
                ...
                )
        {
            ...
            await MissionManager.UpdateProgress(gdkey, DataClasses.Mission.MissionType.GetSpecificYokaiToLevel, (int)youkaiId, progressToUpdate2: youkai.Level);
        }
